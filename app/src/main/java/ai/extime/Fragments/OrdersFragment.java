...
public class OrdersFragment extends Fragment implements PopupsInter {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        mainView = inflater.inflate(R.layout.orders_layout_content, viewGroup, false);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        ((TextView) toolbarC.findViewById(R.id.toolbar_title)).setText("Orders");
